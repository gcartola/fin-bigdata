...
def create_signed_upload_url(
    ...
    # Do not bind Content-Type into the signature. Browsers may send a MIME type
    # different from the dropdown value for XLS/XLSX/CSV uploads, which causes
    # GCS V4 signed PUT requests to fail with HTTP 403.
    kwargs = {
        "version": "v4",
